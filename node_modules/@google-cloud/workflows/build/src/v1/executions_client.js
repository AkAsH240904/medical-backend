...
class ExecutionsClient {
    ...
    _universeDomain;
    _servicePath;
    _log = google_gax_1.loggingUtils.log('workflow-executions');
    auth;
    descriptors = {
        page: {},
        stream: {},
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.workflows.executions.v1.Executions', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.executionsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.workflows.executions.v1.Executions') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.workflows.executions.v1.Executions, this._opts, this._providedCustomServicePath);
