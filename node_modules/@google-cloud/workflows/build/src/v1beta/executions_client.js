...
class ExecutionsClient {
    ...
    _universeDomain;
    _servicePath;
    _log = google_gax_1.loggingUtils.log('workflows-executions');
    auth;
    descriptors = {
        page: {},
        stream: {},
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            executionPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/workflows/{workflow}/executions/{execution}'),
            workflowPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/workflows/{workflow}'),
        };
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.workflows.executions.v1beta.Executions', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.executionsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.workflows.executions.v1beta.Executions') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.workflows.executions.v1beta.Executions, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const executionsStubMethods = ['listExecutions', 'createExecution', 'getExecution', 'cancelExecution'];
